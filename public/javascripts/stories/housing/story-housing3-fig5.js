...
let planningMap = new L.Map('planning-permissions-map')
...
d3.json('/data/Stories/Housing/part_3/Dublin_Housing_Task_Force_Q3_2019_T1.geojson')
  .then(function (data) {
    processPlanningPermissions(data.features, 1)
  })

d3.json('/data/Stories/Housing/part_3/Dublin_Housing_Task_Force_Q3_2019_T2A.geojson')
.then(function (data) {
  processPlanningPermissions(data.features, 2)
})
