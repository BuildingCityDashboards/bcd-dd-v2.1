...
Promise.all([
    ...
    let tracesFig8 = tracesUnauthorisedFig8.concat(tracesAccomodatedFig8);
    ...
    //Set layout options
    let layoutFig8 = Object.assign({}, STACKED_AREA_CHART_LAYOUT);
    //layoutFig8.title.text = titleFig8;
    // layoutFig8.height = 500;
    layoutFig8.showlegend = false;
    layoutFig8.xaxis = Object.assign({}, STACKED_AREA_CHART_LAYOUT.xaxis);
    layoutFig8.xaxis.title = 'Year';
    layoutFig8.xaxis.nticks = 6;
    layoutFig8.xaxis.range = [2001.9, 2013.1];
    layoutFig8.yaxis.title = 'Sites';
    layoutFig8.yaxis = Object.assign({}, STACKED_AREA_CHART_LAYOUT.yaxis);
    layoutFig8.yaxis.fixedrange = false;
    layoutFig8.yaxis.range = [1, 1000];
    // layoutFig8.yaxis.visible = false;
    layoutFig8.margin = Object.assign({}, STACKED_AREA_CHART_LAYOUT.margin);
    layoutFig8.margin = {
      l: 65,
      r: marginRUnauth,
      t: 100, //button row
    ...
    layoutFig8.updatemenus = updateMenus;
    layoutFig8.annotations = unauthorisedAnnotations;

    Plotly.newPlot(divIDFig8, tracesFig8, layoutFig8, {
      modeBar: {
        orientation: 'v',
        bgcolor: 'black',
        color: null,
