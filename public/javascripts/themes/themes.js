...
// });
  ...
  Promise.all([
    ...
    const houseCompMonthly = new GroupedBarChartNew(dataSet3, columnNames3, xValue, "#hc-glance", "Units", "title2");
   
    const priceListQuartley = new GroupedBarChartNew(dataSet4, columnNames4, xValue2, "#ap-glance", "€", "title2");
