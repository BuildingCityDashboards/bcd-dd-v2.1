...
d3.csv('/data/Economy/processed/unemployment_quarterly_dublin.csv')
  .then(unemploymentData => {
    ...
    const info = getInfoText('#employment-card a', 'Unemployment in Dublin for ', ' on the previous quarter', unemploymentDataSet, unemploymentColumnName, 'label', d3.format(''), true)
