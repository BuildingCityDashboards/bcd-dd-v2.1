...
const getirishTraind = async url => {
...
exports.getTrainStationsList = async (req, res, next) => {
  // console.log("\n\n**********Get Stations List******************\n");
  let url = "http://api.irishrail.ie/realtime/realtime.asmx/getAllStationsXML";
  const response = await getirishTraind(url);
  res.send(response);
};


exports.getTrainStationsData = async (req, res, next) => {
    // console.log("\n\n**********Get Stations List******************\n");
    let ts = req.params.ts;
    let url= "http://api.irishrail.ie/realtime/realtime.asmx/getStationDataByNameXML?StationDesc="+ts 
    //let url = "http://api.irishrail.ie/realtime/realtime.asmx/getAllStationsXML";
    const response = await getirishTraind(url);
    res.send(response);
  };
