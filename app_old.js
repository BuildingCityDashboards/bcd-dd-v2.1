...
var census2016Connection = mongooseCensus.createConnection(censusDBURL, {
  useNewUrlParser: true
});

let SmallAreaSchema = new mongooseCensus.Schema(
{
  "GEOGID": {type: String, required: true, max: 32},
});
var SmallArea = census2016Connection.model('SmallArea', SmallAreaSchema);

//var census2016Connection = mongooseCensus.connection;
census2016Connection.on('connected', function() {
  console.log("Connected to Census MongoDB Database");
});
census2016Connection.on('error', console.error.bind(console, 'Census MongoDB connection error:'));

////Dublin Bikes DB
//var dublinbikesDB;
//mongoClient.connect(process.env.BIKES_DB_URL, {
//  useNewUrlParser: true
//}, (err, client) => {
//  if (err) {
...
//
//  dublinbikesDB = client.db('dublinbikes');
//
//});
